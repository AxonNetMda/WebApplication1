...
Namespace Wsaa
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute([Namespace]:="https://wsaahomo.afip.gov.ar/ws/services/LoginCms", ConfigurationName:="Wsaa.LoginCMS")>  _
    Public Interface LoginCMS
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="", ReplyAction:="*"),  _
         System.ServiceModel.FaultContractAttribute(GetType(Wsaa.LoginFault), Action:="", Name:="fault")>  _
        Function loginCms(ByVal request As Wsaa.loginCmsRequest) As Wsaa.loginCmsResponse
    End Interface
    ...
    Public Interface LoginCMSChannel
        Inherits Wsaa.LoginCMS, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class LoginCMSClient
        Inherits System.ServiceModel.ClientBase(Of Wsaa.LoginCMS)
        Implements Wsaa.LoginCMS
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function Wsaa_LoginCMS_loginCms(ByVal request As Wsaa.loginCmsRequest) As Wsaa.loginCmsResponse Implements Wsaa.LoginCMS.loginCms
            Return MyBase.Channel.loginCms(request)
        End Function
        
        Public Function loginCms(ByVal in0 As String) As String
            Dim inValue As Wsaa.loginCmsRequest = New Wsaa.loginCmsRequest()
            inValue.in0 = in0
            Dim retVal As Wsaa.loginCmsResponse = CType(Me,Wsaa.LoginCMS).loginCms(inValue)
